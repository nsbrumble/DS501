...
data <- read.csv("C:\\Users\\natha\\Downloads\\wpi\\DS 501\\motodata.csv")
  ...
  tabPanel(
    ...
    sidebarLayout(
      sidebarPanel(
        ...
        uiOutput("predictor_inputs"),  # Dynamically generate numeric inputs for predictors
        actionButton("predict", "Make Prediction"),
        verbatimTextOutput("prediction_result")  # Display prediction result
      ),
      mainPanel(
